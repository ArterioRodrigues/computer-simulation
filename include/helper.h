...
// RANDOM VARIABLE GEN
double transformationMethodPoisson(double lambda, std::optional<double> randomValue = std::nullopt);
double transformationMethodPoissonLog(double lambda, std::optional<double> randomValue = std::nullopt);
...
// SIMULATIONS
std::vector<double> discreteEventSimulation(double timeInterval, double numberOfReplication, double initalOccupancy,
                                            double lambda = 6, double client1Rate = 3, double client2Rate = 1,
                                            double client3Rate = 4, float client1Fee = 0.5, float client2Fee = 0.1,
                                            float client3Fee = 1.25, float client1PenaltyRate = 1.0,
...
std::vector<double> retrospectiveSimulation(double timeInterval, double numberOfReplication, double initalOccupancy,
                                            ...
                                            float client3Fee = 1.25, float client1PenaltyRate = 1.0,
                                            float client2PenaltyRate = 0.25);
double queueSimulation(double lambda, double serverDispatchRate, double iterations = 1000);
